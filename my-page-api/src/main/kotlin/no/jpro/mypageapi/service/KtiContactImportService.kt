...
class KtiContactImportService(
    ...
    private val logger = LoggerFactory.getLogger(KtiContactImportService::class.java)
    ...
    fun importContacts(
        ...
        logger.info("=== KTI Contacts Import Started ===")
        ...
        val contactsByEmail = mutableMapOf<String, KtiCustomerContact>()
        ...
        for (row in validRows) {
            ...
            var contact: KtiCustomerContact? = null
            if (row.email != null) {
                ...
                if (contact == null) {
                    ...
                    if (existingContact != null) {
                        ...
                        contact = contactRepository.save(KtiCustomerContact(
            ...
            if (row.year != null && contact != null) {
                ...
                val assignment = if (existingAssignment == null) {
                    val newAssignment = assignmentRepository.save(KtiAssignment(
                        round = round,
