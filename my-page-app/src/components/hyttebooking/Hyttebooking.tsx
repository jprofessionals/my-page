...
function Hyttebooking() {
  const [showMonthOverview] = useState(true)
  const [showYearOverview] = useState(false)
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 p-4">
        ...
        <p>
          ...
          ønsket ble meldt. Er det mindre en 7 dager til ønsket periode starter
          må trekningen gjøres manuelt, si ifra til Roger for få gjennomført en
          trekning. Når en trekning er gjennomført postes det en melding til{' '}
          <a
            href="https://jpro.slack.com/archives/C83007C8L"
            className="text-warning"
          >
