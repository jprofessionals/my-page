...
const InfoNoticeItem = ({
  ...
  showEditFormForInfoNotice,
  onCloseModal,
  infoNoticeDeleteModalIsOpen,
  onRefreshNoticeVacancies,
  showCreateFormForInfoNotice,
  infoNoticeVacancies,
  onAddInfoNoticeClick,
  date,
  onEditInfoNotice,
  ...
  >
    ...
    <MonthOverviewModal
      open={infoNoticeDeleteModalIsOpen}
      onClose={onCloseModal}
      label="Delete Confirmation"
    >
      <div>
        <p className="mb-3">Er du sikker på at du vil slette notisen?</p>
