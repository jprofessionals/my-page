...
export default function ImportTab() {
  ...
  const loadUsersAndAliases = async () => {
    try {
      const [usersRes, aliasesRes] = await Promise.all([
        ...
        ktiService.getConsultantAliases(),
      ])
  ...
  const handleDeleteAlias = async (aliasId: number) => {
    try {
      await ktiService.deleteConsultantAlias(aliasId)
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Før du importerer KTI-data, bør du synkronisere konsulent-listen fra Flowcase.
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-medium text-blue-900 mb-2">Importere historiske KTI-data</h3>
