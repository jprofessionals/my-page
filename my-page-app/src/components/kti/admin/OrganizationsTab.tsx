...
import ktiService, { KtiCustomerOrganization, CreateKtiOrganization, UpdateKtiOrganization } from '@/services/kti.service'
...
export default function OrganizationsTab() {
  ...
  const [newOrg, setNewOrg] = useState<CreateKtiOrganization>({ name: '' })
  const [editOrg, setEditOrg] = useState<KtiCustomerOrganization | null>(null)
  ...
  const handleCreateOrganization = async () => {
    ...
    setCreating(true)
    try {
      await ktiService.createOrganization(newOrg)
  ...
  const handleUpdateOrganization = async () => {
    ...
    try {
      ...
      await ktiService.updateOrganization(editOrg.id, updateData)
  ...
  const openEditModal = (org: KtiCustomerOrganization) => {
    setEditOrg({ ...org })
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {organizations.map((org) => (
                <tr key={org.id} className={`hover:bg-gray-50 ${!org.active ? 'opacity-50' : ''}`}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewOrg({ ...newOrg, organizationNumber: e.target.value || undefined })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditOrg({ ...editOrg, organizationNumber: e.target.value || undefined })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2"
                />
              </div>
              <div>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setEditOrg({ ...editOrg, active: e.target.checked })}
                    className="rounded"
                  />
