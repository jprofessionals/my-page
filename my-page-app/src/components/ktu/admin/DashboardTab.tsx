            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-bold text-blue-600">{latestStats.roundName}</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-400">{latestStats.totalResponses} svar</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold text-purple-600">{latestStats.consultantCount}</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold text-orange-600">{latestStats.organizationCount}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          {trendData.questionTrends && trendData.questionTrends.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Score per spørsmål over tid</h3>
              {trendData.questionTrends.map((qt) => {
                ...
                const chartData = Object.entries(qt.yearlyAverages || {})
                  .map(([yearStr, value]) => ({
                    ...
                    responseCount: responseCounts[yearStr] ?? responseCounts[parseInt(yearStr) as unknown as string],
                  }))
                  .sort((a, b) => a.year - b.year)
          ...
          {trendData.yearlyStatistics && trendData.yearlyStatistics.length > 0 && (
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-4 border-b">
                <h3 className="text-lg font-semibold text-gray-900">Årlig oversikt</h3>
              </div>
