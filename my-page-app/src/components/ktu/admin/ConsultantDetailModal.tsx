...
export default function ConsultantDetailModal({
  ...
  const [statistics, setStatistics] =
    useState<KtuConsultantOwnStatistics | null>(null)
  ...
  const loadData = async () => {
    setLoading(true)
    try {
      const [statsResponse, trendsResponse, responsesResponse] =
        await Promise.all([
          ...
          <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between z-10">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Statistikk og tilbakemeldinger fra
                kundetilfredshetsundersokelser
              </p>
            </div>
            <button
              onClick={onClose}
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        {statistics.currentYearStats?.averageScore &&
                          statistics.previousYearStats?.averageScore && (
                            <p
                              className={`text-xs ${getDeltaColor(statistics.currentYearStats.averageScore, statistics.previousYearStats.averageScore)}`}
                            >
                              {formatDelta(
                                statistics.currentYearStats.averageScore,
                                statistics.previousYearStats.averageScore,
                          ...
                          >
                            ...
                            <div className="space-y-2">
                              {response.questionResponses?.map((qr) => {
                                ...
                                const hasText =
                                  qr.textValue != null && qr.textValue !== ''
                                const isTextOnlyQuestion =
                                  qr.questionType === 'FREE_TEXT'
                                ...
                                if (isTextOnlyQuestion) {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <p className="text-sm text-gray-700 italic pl-3 border-l-2 border-blue-300">
                                        {qr.textValue}
                                      </p>
                                    </div>
                                  )
                                ...
                                return (
                                  ...
                                  >
                                    <div className="flex items-start justify-between gap-3">
                                      ...
                                      <span
                                        className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold flex-shrink-0 ${hasScore ? getScoreColor(qr.ratingValue!) : 'bg-gray-100 text-gray-400'}`}
                                      >
