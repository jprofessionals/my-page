...
export default function ContactsTab() {
  ...
  const loadOrganizations = async () => {
    try {
      const response = await ktuService.getOrganizations(false)
  ...
  const loadContacts = async () => {
    setLoading(true)
    try {
      const response = await ktuService.getContacts(filterOrgId, !showInactive)
  ...
  const openEditModal = (contact: KtuCustomerContact) => {
